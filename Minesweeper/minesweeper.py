...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # At some point we are gonna call the sentence object
        ...
        remaining_mines = count - mines
        new_sentence = Sentence(unknownCells, remaining_mines)
    ...
    #5) add any new sentences to the AI's knowledge base
        ...
        for sentence in self.knowledge:
            if new_sentence.cells.issubset(sentence.cells) and sentence != new_sentence:
                ...
                final_sentence = Sentence(list(new_subset), new_count)
